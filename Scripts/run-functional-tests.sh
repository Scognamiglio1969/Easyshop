...
OUT="$ROOT/work/easyshop-functional-test"
...
swiftc \
    ...
    "$ROOT/Sources/EasyshopApp/Models/EditorWorkspace.swift" \
    ...
    "$ROOT/Sources/EasyshopApp/Services/PreviewRenderService.swift" \
    "$ROOT/Sources/EasyshopApp/Services/PSDWriter.swift" \
    "$ROOT/Sources/EasyshopApp/Services/ProjectIO.swift" \
    "$ROOT/Sources/EasyshopApp/Services/RecoveryService.swift" \
    "$ROOT/Sources/EasyshopApp/Services/RuntimeSmokeTest.swift" \
    "$ROOT/Tests/FunctionalTest.swift" \
    -framework AppKit \
    -framework CoreImage \
